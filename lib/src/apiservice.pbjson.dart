...
const CandlesRequest$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 14,
      '6': '.antaresWallet.CandleInterval',
      '10': 'interval'
    },
    const {
      '1': 'from',
...
const GenerateWalletRequest$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.antaresWallet.GenerateWalletRequest.BcnWalletRequest',
      '10': 'bcnWallet'
    },
  ],
...
const SwiftCashoutRequest$json = const {
  ...
  '2': const [
    ...
    const {
      '1': 'prevTempPrivateKey',
      '3': 3,
      '4': 1,
      '5': 9,
      '10': 'prevTempPrivateKey'
    },
...
const SwiftCashoutFinalizeRequest$json = const {
  ...
  '2': const [
    ...
    const {
      '1': 'clientRevokePubKey',
      '3': 2,
      '4': 1,
      '5': 9,
      '10': 'clientRevokePubKey'
    },
    const {
      '1': 'clientRevokeEncryptedPrivateKey',
      '3': 3,
      '4': 1,
      '5': 9,
      '10': 'clientRevokeEncryptedPrivateKey'
    },
    const {
      '1': 'signedTransferTransaction',
      '3': 4,
      '4': 1,
      '5': 9,
      '10': 'signedTransferTransaction'
    },
  ],
};
...
const CryptoCashoutRequest$json = const {
  ...
  '2': const [
    ...
    const {
      '1': 'destinationAddressExtension',
      '3': 4,
      '4': 1,
      '5': 9,
      '10': 'destinationAddressExtension'
    },
  ],
};
...
const BaseAssetResponse$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.antaresWallet.BaseAssetResponse.BaseAsset',
      '10': 'baseAsset'
    },
    const {
      '1': 'error',
...
const LimitOrdersResponse$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.antaresWallet.LimitOrdersResponse.OrdersPayload',
      '10': 'result'
    },
    const {
      '1': 'error',
...
const LimitOrdersResponse_OrdersPayload$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.antaresWallet.LimitOrderModel',
      '10': 'orders'
    },
  ],
};
...
const PlaceOrderResponse$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.antaresWallet.PlaceOrderResponse.OrderPayload',
      '10': 'result'
    },
    const {
      '1': 'error',
...
const LimitOrderModel$json = const {
  ...
  '2': const [
    ...
    const {
      '1': 'remainingOtherVolume',
      '3': 10,
      '4': 1,
      '5': 9,
      '10': 'remainingOtherVolume'
    },
  ],
};
...
const TierInfoRespone$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.antaresWallet.TierInfoPayload',
      '10': 'result'
    },
    const {
      '1': 'error',
...
const TierInfoPayload$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.antaresWallet.UpgradeRequest',
      '10': 'upgradeRequest'
    },
    const {
...
const WalletsResponse$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.antaresWallet.WalletsResponse.GetWalletsPayload',
      '10': 'result'
    },
    const {
      '1': 'error',
  ...
  '3': const [
    WalletsResponse_GetWalletsPayload$json,
    WalletsResponse_LykkeWalletsPayload$json,
    WalletsResponse_WalletAsset$json
  ],
};
...
const WalletsResponse_GetWalletsPayload$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.antaresWallet.WalletsResponse.LykkeWalletsPayload',
      '10': 'lykke'
    },
...
const WalletsResponse_LykkeWalletsPayload$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.antaresWallet.WalletsResponse.WalletAsset',
      '10': 'assets'
    },
...
const WalletResponse$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.antaresWallet.WalletResponse.WalletPayload',
      '10': 'result'
    },
    const {
      '1': 'error',
...
const GenerateWalletResponse$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.antaresWallet.GenerateWalletResponse.WalletAddress',
      '10': 'result'
    },
    const {
      '1': 'error',
  ...
  '3': const [
    GenerateWalletResponse_WalletAddress$json,
    GenerateWalletResponse_BcnAddressExtension$json
  ],
};
...
const GenerateWalletResponse_WalletAddress$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.antaresWallet.GenerateWalletResponse.BcnAddressExtension',
      '10': 'addressExtension'
    },
  ],
};
...
const GenerateWalletResponse_BcnAddressExtension$json = const {
  ...
  '2': const [
    const {
      '1': 'addressExtensionDisplayName',
      '3': 1,
      '4': 1,
      '5': 9,
      '10': 'addressExtensionDisplayName'
    },
    const {
      '1': 'baseAddressDisplayName',
      '3': 2,
      '4': 1,
      '5': 9,
      '10': 'baseAddressDisplayName'
    },
    const {
      '1': 'depositAddressExtension',
      '3': 3,
      '4': 1,
      '5': 9,
      '10': 'depositAddressExtension'
    },
    const {
      '1': 'typeForDeposit',
      '3': 4,
...
const SwiftCredentialsResponse$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.antaresWallet.SwiftCredentialsResponse.SwiftCredentials',
      '10': 'result'
    },
    const {
      '1': 'error',
...
const SwiftCredentialsResponse_SwiftCredentials$json = const {
  ...
  '2': const [
    ...
    const {
      '1': 'correspondentAccount',
      '3': 7,
      '4': 1,
      '5': 9,
      '10': 'correspondentAccount'
    },
  ],
};
...
const CountryPhoneCodesResponse$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.antaresWallet.CountryPhoneCodesResponse.CountryPhoneCodes',
      '10': 'result'
    },
    const {
      '1': 'error',
...
const BankCardPaymentDetailsResponse$json = const {
  ...
  '2': const [
    const {
      ...
      '5': 11,
      '6':
          '.antaresWallet.BankCardPaymentDetailsResponse.BankCardPaymentDetails',
      '10': 'result'
    },
    const {
      '1': 'error',
...
const BankCardPaymentUrlResponse$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.antaresWallet.BankCardPaymentUrlResponse.BankCardPaymentUrl',
      '10': 'result'
    },
    const {
      '1': 'error',
...
const EthereumSettingsResponse$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.antaresWallet.EthereumSettingsResponse.EthereumSettings',
      '10': 'result'
    },
    const {
      '1': 'error',
  ...
  '3': const [
    EthereumSettingsResponse_EthereumSettings$json,
    EthereumSettingsResponse_BitcoinFee$json
  ],
};
...
const EthereumSettingsResponse_EthereumSettings$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.antaresWallet.EthereumSettingsResponse.BitcoinFee',
      '10': 'bitcoin'
    },
  ],
};
...
const CryptoDepositAddressResponse$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.antaresWallet.CryptoDepositAddressResponse.CryptoDepositAddress',
      '10': 'address'
    },
    const {
      '1': 'error',
...
const WithdrawalCryptoInfoResponse$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.antaresWallet.WithdrawalCryptoInfoResponse.WithdrawalCryptoInfo',
      '10': 'withdrawalInfo'
    },
    const {
      '1': 'error',
...
const WithdrawalCryptoInfoResponse_WithdrawalCryptoInfo$json = const {
  ...
  '2': const [
    ...
    const {
      '1': 'addressExtensionMandatory',
      '3': 2,
      '4': 1,
      '5': 8,
      '10': 'addressExtensionMandatory'
    },
    const {
      '1': 'addressExtensionTitle',
      '3': 3,
      '4': 1,
      '5': 9,
      '10': 'addressExtensionTitle'
    },
  ],
};
...
const SwiftCashoutInfoResponse$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.antaresWallet.SwiftCashoutInfoResponse.SwiftCashoutInfo',
      '10': 'result'
    },
    const {
      '1': 'error',
...
const OffchainChannelKeyResponse$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.antaresWallet.OffchainChannelKeyResponse.OffchainChannel',
      '10': 'result'
    },
    const {
      '1': 'error',
...
const SwiftCashoutResponse$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.antaresWallet.SwiftCashoutResponse.SwiftCashoutData',
      '10': 'result'
    },
    const {
      '1': 'error',
...
const SwiftCashoutFinalizeResponse$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.antaresWallet.SwiftCashoutFinalizeResponse.OffchainTradeRespone',
      '10': 'result'
    },
    const {
      '1': 'error',
  ...
  '3': const [
    SwiftCashoutFinalizeResponse_OffchainTradeRespone$json,
    SwiftCashoutFinalizeResponse_OffchainOrder$json
  ],
};
...
const SwiftCashoutFinalizeResponse_OffchainTradeRespone$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.antaresWallet.SwiftCashoutFinalizeResponse.OffchainOrder',
      '10': 'order'
    },
  ],
};
...
const AppSettingsResponse$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.antaresWallet.AppSettingsResponse.AppSettingsData',
      '10': 'result'
    },
    const {
      '1': 'error',
  ...
  '3': const [
    AppSettingsResponse_AppSettingsData$json,
    AppSettingsResponse_ApiAsset$json,
    AppSettingsResponse_ApiRefundSettings$json,
    AppSettingsResponse_ApiFeeSettings$json
  ],
};
...
const AppSettingsResponse_AppSettingsData$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.antaresWallet.AppSettingsResponse.ApiAsset',
      '10': 'BaseAsset'
    },
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.antaresWallet.AppSettingsResponse.ApiRefundSettings',
      '10': 'RefundSettings'
    },
    const {
      '1': 'MarketOrderPriceDeviation',
      '3': 7,
      '4': 1,
      '5': 1,
      '10': 'MarketOrderPriceDeviation'
    },
    const {
      '1': 'FeeSettings',
      '3': 8,
      '4': 1,
      '5': 11,
      '6': '.antaresWallet.AppSettingsResponse.ApiFeeSettings',
      '10': 'FeeSettings'
    },
  ],
};
...
const AppSettingsResponse_ApiAsset$json = const {
  ...
  '2': const [
    ...
    const {
      '1': 'bankCardsDepositEnabled',
      '3': 8,
      '4': 1,
      '5': 8,
      '10': 'bankCardsDepositEnabled'
    },
    const {
      '1': 'swiftDepositEnabled',
      '3': 9,
      '4': 1,
      '5': 8,
      '10': 'swiftDepositEnabled'
    },
    const {
      '1': 'blockchainDepositEnabled',
      '3': 10,
      '4': 1,
      '5': 8,
      '10': 'blockchainDepositEnabled'
    },
    const {
      '1': 'otherDepositOptionsEnabled',
      '3': 11,
      '4': 1,
      '5': 8,
      '10': 'otherDepositOptionsEnabled'
    },
...
const AppSettingsResponse_ApiFeeSettings$json = const {
  ...
  '2': const [
    const {
      '1': 'BankCardsFeeSizePercentage',
      '3': 1,
      '4': 1,
      '5': 1,
      '10': 'BankCardsFeeSizePercentage'
    },
    const {
      '1': 'CashOut',
      '3': 2,
...
const PrivateWalletsResponse$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.antaresWallet.PrivateWalletsResponse.PrivateWalletsPayload',
      '10': 'result'
    },
    const {
      '1': 'error',
...
const SwiftCashoutFeeResponse$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.antaresWallet.SwiftCashoutFeeResponse.SwiftCashoutFee',
      '10': 'result'
    },
    const {
      '1': 'error',
...
const Error$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.antaresWallet.Error.FieldsEntry',
      '10': 'fields'
    },
  ],
